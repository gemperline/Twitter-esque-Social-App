...
class login extends Component {
    ...
    render() {
        ...
        // destructuring 
        const { classes, UI: { loading } } = this.props;  // get loading from within the UI
            ...
            <Grid container className={classes.form}>
                ...
                <Grid item sm>
                    ...
                    <form noValidate onSubmit={this.handleSubmit}>
                        ...
                        <br />
                        <small className={classes.smallText}>Don't have an account?&nbsp;
                            <Link to="/register" variant="body2" className={classes.linkAtts}>Register for free</Link>
                        </small>
                    </form>
                </Grid>
                <Grid item sm />
